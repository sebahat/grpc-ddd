...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.orderservice.grpc.PlaceOrderRequest,
      com.example.orderservice.grpc.PlaceOrderResponse> getPlaceOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PlaceOrder",
      requestType = com.example.orderservice.grpc.PlaceOrderRequest.class,
      responseType = com.example.orderservice.grpc.PlaceOrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.orderservice.grpc.PlaceOrderRequest,
      com.example.orderservice.grpc.PlaceOrderResponse> getPlaceOrderMethod() {
    io.grpc.MethodDescriptor<com.example.orderservice.grpc.PlaceOrderRequest, com.example.orderservice.grpc.PlaceOrderResponse> getPlaceOrderMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getPlaceOrderMethod = OrderServiceGrpc.getPlaceOrderMethod) == null) {
          OrderServiceGrpc.getPlaceOrderMethod = getPlaceOrderMethod =
              io.grpc.MethodDescriptor.<com.example.orderservice.grpc.PlaceOrderRequest, com.example.orderservice.grpc.PlaceOrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PlaceOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.orderservice.grpc.PlaceOrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.orderservice.grpc.PlaceOrderResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void placeOrder(com.example.orderservice.grpc.PlaceOrderRequest request,
        io.grpc.stub.StreamObserver<com.example.orderservice.grpc.PlaceOrderResponse> responseObserver) {
  ...
  public static final class OrderServiceStub
    ...
    /**
     */
    public void placeOrder(com.example.orderservice.grpc.PlaceOrderRequest request,
        io.grpc.stub.StreamObserver<com.example.orderservice.grpc.PlaceOrderResponse> responseObserver) {
  ...
  public static final class OrderServiceBlockingStub
    ...
    /**
     */
    public com.example.orderservice.grpc.PlaceOrderResponse placeOrder(com.example.orderservice.grpc.PlaceOrderRequest request) {
  ...
  public static final class OrderServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.orderservice.grpc.PlaceOrderResponse> placeOrder(
        com.example.orderservice.grpc.PlaceOrderRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PLACE_ORDER:
          serviceImpl.placeOrder((com.example.orderservice.grpc.PlaceOrderRequest) request,
              (io.grpc.stub.StreamObserver<com.example.orderservice.grpc.PlaceOrderResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.orderservice.grpc.PlaceOrderRequest,
              com.example.orderservice.grpc.PlaceOrderResponse>(
  ...
  private static abstract class OrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.orderservice.grpc.OrderProto.getDescriptor();
    }
